...
GRANT USAGE ON SCHEMA PC_FIVETRAN_DB.HASHMAP_SNOWFLAKE_USEAGE TO ROLE PC_FIVETRAN_ROLE;
GRANT CREATE SCHEMA, USAGE ON DATABASE PC_FIVETRAN_DB TO ROLE PC_FIVETRAN_ROLE;
GRANT CREATE TABLE ON SCHEMA PC_FIVETRAN_DB.HASHMAP_SNOWFLAKE_USEAGE TO ROLE PC_FIVETRAN_ROLE;
